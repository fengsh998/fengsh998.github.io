...
寄存器操作 (Register Programming):
 ...
 - **标准外设库 (SPL - Standard Peripheral Library)**，标准库文档[官方下载连接](https://www.st.com/en/embedded-software/stm32-standard-peripheral-libraries.html),在线函数和结构体定义[连接](http://stm32.kosyak.info/doc/struct_a_d_c___type_def.html)
