...
CentOS 8.0 + Docker V20.10.16 + Docker Compose V2.7.0
...
安装完成后使用http://localhost:18070 进配置管理界面，用户名apollo,密码admin


[官方文档](https://www.apolloconfig.com/#/zh/README)
[快速部署参考](https://www.apolloconfig.com/#/zh/deployment/quick-start)
[docker 部署](https://www.apolloconfig.com/#/zh/deployment/quick-start-docker)